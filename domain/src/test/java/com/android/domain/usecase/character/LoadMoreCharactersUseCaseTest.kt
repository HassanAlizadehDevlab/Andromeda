...
class LoadMoreCharactersUseCaseTest {
    ...
    fun setup() {
        ...
        useCase = LoadMoreCharactersUseCase(repository, TestCTransformer())
    }
    ...
    fun execute() {
        // GIVEN
        Mockito.doReturn(Completable.complete()).whenever(repository).loadMoreCharacters()
        ...
        // THEN
        Mockito.verify(repository).loadMoreCharacters()
    }
